...
class SynthTextDataset(Dataset):
    ...
    def __base_getitem__(self, item_index):
        ...
        index = original_image_name.split(".")[0]
        ...
        if os.path.isfile(depth1_file):
            ...
            depth1 = self.depth_predictor.infer(original_image_as_tensor.unsqueeze(0)).squeeze()
        ...
        if os.path.isfile(depth2_file):
            ...
            depth2 = self.depth_predictor.infer(synth_image_as_tensor.unsqueeze(0)).squeeze()
