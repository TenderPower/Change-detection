...
import numpy
from utils.utils import transform, DLT_solve
...
class ResNet(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        batch_size, _, img_h, img_w = inputs1.size()
        ...
        mask_I1_full = self.genMask(inputs1)
        mask_I2_full = self.genMask(inputs2)
        # 对mask进行归一化
        mask_I1 = normMask(mask_I1_full)

        mask_I2 = normMask(mask_I2_full)

        patch_1 = self.ShareFeature(inputs1)
        patch_2 = self.ShareFeature(inputs2)
